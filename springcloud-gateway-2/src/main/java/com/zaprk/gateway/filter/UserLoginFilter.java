...
public class UserLoginFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        if (url.startsWith("http://172.18.84.32:9960/my-goods-service")
                ...
                url.startsWith("http://172.18.84.32:9960/my-sort-service")
                ||
                url.startsWith("http://localhost:9960/my-address-service")
                ||
                url.startsWith("http://172.18.84.32:9960/my-address-service")
                ...
                ||
                url.startsWith("http://localhost:9960/my-comment-service")
                ||
                url.startsWith("http://172.18.84.32:9960/my-comment-service")
        ) {
            return false;//不经过过滤器
        }
        return true;
